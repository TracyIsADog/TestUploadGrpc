...
- (instancetype)initWithHost:(NSString *)host {
  return (self = [super initWithHost:host packageName:@"user_auth" serviceName:@"UserAuthApi"]);
}
...
#pragma mark RegisterSmsStep3Signin(SmsStep3SigninRequest) returns (SigninResponse)

/**
 * local
 */
- (void)registerSmsStep3SigninWithRequest:(USRATHSmsStep3SigninRequest *)request handler:(void(^)(USRATHSigninResponse *_Nullable response, NSError *_Nullable error))handler{
  [[self RPCToRegisterSmsStep3SigninWithRequest:request handler:handler] start];
}
// Returns a not-yet-started RPC object.
/**
 * local
 */
- (GRPCProtoCall *)RPCToRegisterSmsStep3SigninWithRequest:(USRATHSmsStep3SigninRequest *)request handler:(void(^)(USRATHSigninResponse *_Nullable response, NSError *_Nullable error))handler{
  return [self RPCToMethod:@"RegisterSmsStep3Signin"
            requestsWriter:[GRXWriter writerWithValue:request]
             responseClass:[USRATHSigninResponse class]
        responsesWriteable:[GRXWriteable writeableWithSingleHandler:handler]];
}
